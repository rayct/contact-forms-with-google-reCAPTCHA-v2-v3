...
if (isValid()) {
    ...
    $recaptcha_secret = '6LeHHuQlAAAAAJ43zzwjqEWsKjFjBL0IdiWGm6ZL'; // Secret key
    ...
    if($recaptcha->success == true && $recaptcha->score >= 0.5 && $recaptcha->action == "contact"){ // If the response is valid
        ...
        // run email send routine
        $to = 'info@rayturner.dev'; // Replace with the email address you want to send the message to
        $subject = 'New message from ' . $_POST['no-reply@rayturner.dev'] . ' ' .
